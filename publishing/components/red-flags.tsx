import { PathwayRedFlags } from '@/tina/__generated__/types';
import { useState } from 'react';

function RedFlagComponent({ intro, flags }: PathwayRedFlags) {
      ...
      {isPopupOpen && (
        <div className="absolute right-0 top-10 z-50 w-64 rounded-lg bg-white p-4 shadow-lg">
          ...
          <p className="mt-2 text-sm">
            HealthPathways red flags signal the most serious clinical risks that are easily missed. The list
          ...
          <p className="mt-2 text-sm">
            ...
            <ul className="list-disc pl-4">
              ...
              <li>
                If missed, it can significantly threaten the patient&apos;s health or have legal consequences
                for the clinician.
              </li>
            </ul>
          </p>
